        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>View and manage loan information</CardDescription>
            </div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                <h3 className="text-sm font-medium text-muted-foreground">Borrower Information</h3>
              ...
              <div>
                <h3 className="text-sm font-medium text-muted-foreground">Loan Terms</h3>
                <div className="mt-2 grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium bg-green-100 text-green-800">
                      Active
                    </p>
                  </div>
                </div>
